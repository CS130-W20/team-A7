...
class SavedTripsBase extends Component {
  constructor(props) {
    ...
    var trip = new Trip('SavedTrip1', departureFlight, returnFlight, hotelStay);
    var tripItem = new SavedTripsItem(trip, this.state.trips.length);
