...
class Places {
  ...
  async getPointsOfInterest(latitude, longitude) {
    ...
    return fetch(proxyurl + 'https://maps.googleapis.com/maps/api/place/nearbysearch/json?location=' + latitude + ',' + longitude + '&radius=7500&type=tourist_attraction&key=AIzaSyC3Xpkfx9-L-4RHy87AP75GCoOUGSzpVS0');
  }
